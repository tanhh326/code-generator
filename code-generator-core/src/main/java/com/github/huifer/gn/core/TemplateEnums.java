...
public enum TemplateEnums {
  ...
  ENTITY("entity.java.ftl", "Entity.java", "entity"),
  ...
  persistence("persistenceservice.java.ftl", "Persistence.java", "persistence"),
  persistence_impl("persistenceserviceimpl.java.ftl", "PersistenceImpl.java", "persistence.impl"),
