...
package com.github.huifer.user.entity;
...
public class UserEntity {
     ...
     **/
    @Column(name = "phone")
    @com.baomidou.mybatisplus.annotation.TableField(value = "phone")
    private String  phone;
    /**
     * 生日
     **/
    @Column(name = "day")
    @com.baomidou.mybatisplus.annotation.TableField(value = "day")
